...
namespace LuaCore
{
    public static class LuaFunctions
    {
        ...
        public static Klei.AI.AttributeModifier GetAttributeModifier(string attribute_id, float value, string description = null, bool is_multiplier = false, bool uiOnly = false, bool is_readonly = true)
        {
            return new Klei.AI.AttributeModifier(attribute_id, value, description , is_multiplier , uiOnly ,  is_readonly );
        }
